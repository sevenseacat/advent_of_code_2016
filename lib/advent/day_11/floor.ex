defmodule Advent.Day11.Floor do
  ...
  ...>  %Advent.Day11.Floor{chips: [:t, :u], generators: [:v, :w]}) |> Enum.sort
  ...
  defp object_permutations(floor, max_size) do
    Permutations.of(combine_objects(floor), max_size) ++ object_permutations(floor, max_size-1)
  end
