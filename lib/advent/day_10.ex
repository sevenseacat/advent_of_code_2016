defmodule Advent.Day10 do
  alias Advent.Day10.Bot

  @doc """
  iex> Advent.Day10.process_input(["value 5 goes to bot 2",
  ...
  def process_command(["bot", bot_no, "gives", "low", "to", low_type, low_id,
    "and", "high", "to", high_type, high_id]) do
    bot_no = String.to_integer(bot_no)
  ...
  ...>  "bot 0 gives low to output 2 and high to output 0",
  ...>  "value 2 goes to bot 2"], MapSet.new) |>
  ...>  Advent.Day10.process_rules |> Advent.Day10.find_comparison({2, 5})
  2
  """
  def run_scenario do
    input |> process_input(MapSet.new) |> process_rules |> find_comparison({17, 61})
  end
  ...
  def input do
    File.read!("test/fixtures/day_10") |> String.trim |> String.split("\n")
  end
end
