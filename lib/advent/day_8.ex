defmodule Advent.Day8 do
  ...
  @doc """
  iex> Advent.Day8.final_arrangement(["rect 3x2", "rotate column x=1 by 1",
  ...
  @doc """
  iex> Advent.Day8.lit_pixel_count([".#..#.#", "#.#....", ".#....."])
  6
  """
  ...
  def input do
    File.read!("test/fixtures/day_8") |> String.trim |> String.split("\n")
  end

  @doc """
  iex> Advent.Day8.process_line(["rect", "3x2"], [".......", ".......", "......."])
  ["###....", "###....", "......."]

  iex> Advent.Day8.process_line(["rect", "3x2"], [".#.....", ".#....#", ".....#."])
  ["###....", "###...#", ".....#."]

  iex> Advent.Day8.process_line(["rotate", "row", "y=0", "by", "2"], [".......", ".......", "......."])
  [".......", ".......", "......."]

  iex> Advent.Day8.process_line(["rotate", "row", "y=0", "by", "2"], ["#..#...", "#....#.", "......#"])
  ["..#..#.", "#....#.", "......#"]

  iex> Advent.Day8.process_line(["rotate", "row", "y=1", "by", "3"], ["#..#...", "#....#.", "......#"])
  ["#..#...", ".#.#...", "......#"]

  iex> Advent.Day8.process_line(["rotate", "column", "x=0", "by", "2"], [".......", ".......", "......."])
  [".......", ".......", "......."]
  ...
  def process_line(["rotate", "column", "x=" <> column_no, "by", count], state) do
    ...
    column = (for i <- 0..length(state)-1, do: (state |> Enum.at(i) |> String.at(column_no)))
    |> to_string
  ...
  defp process_row_rotate_lines([line | lines], {row_no, count}, current_line_no) do
    new_line = case current_line_no == row_no do
  ...
  @doc """
  iex> Advent.Day8.blank_screen(3, 2)
  ["...", "..."]
  """
